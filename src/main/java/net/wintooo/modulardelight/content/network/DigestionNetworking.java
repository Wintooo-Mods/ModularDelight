...
public class DigestionNetworking {
    ...
    public static final Identifier DIGESTION_SYNC =
            ModularDelight.id("digestion_sync");
    ...
    public static void sync(ServerPlayerEntity player) {
        ...
        for (ActiveMeal meal : meals) {
            buf.writeString(meal.ambient().id());
            buf.writeString(meal.condition().id());
            buf.writeString(meal.activated().id());
        }
